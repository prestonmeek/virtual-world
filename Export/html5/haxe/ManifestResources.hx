...
@:keep @:dox(hide) class ManifestResources {
	...
	public static function init (config:Dynamic):Void {
		...
		data = '{"name":"lib","assets":"aoy4:pathy7:lib.biny4:sizei2297y4:typey4:TEXTy2:idR1y7:preloadtgh","rootPath":"lib/lib","version":2,"libraryArgs":["lib.bin","PJeqv76OVrDjfn6LwmdE"],"libraryType":"openfl._internal.formats.swf.SWFLiteLibrary"}';
...
@:keep @:file("/Users/testing/Desktop/game/Export/html5/obj/libraries/lib/lib.bin") @:noCompletion #if display private #end class __ASSET__lib_bin extends haxe.io.Bytes {}
